...
<html lang="en">
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
    <script src="../../public/css/adminlte-colors-v3.css">
    </script>
    <script src="../../public/css/adminlte-colors-v3.css.map">
    </script>
    <script src="../../public/css/adminlte-colors-v3.min.css">
    </script>
    <script src="../../public/css/adminlte-colors-v3.min.css.map">
    </script>
    <script src="../../public/css/adminlte-colors-v3.rtl.css">
    </script>
    <script src="../../public/css/adminlte-colors-v3.rtl.css.map">
    </script>
    <script src="../../public/css/adminlte-colors-v3.rtl.min.css">
    </script>
    <script src="../../public/css/adminlte-colors-v3.rtl.min.css.map">
    </script>
    <script src="../../public/css/adminlte-colors.css">
    </script>
    <script src="../../public/css/adminlte-colors.css.map">
    </script>
    <script src="../../public/css/adminlte-colors.min.css">
    </script>
    <script src="../../public/css/adminlte-colors.min.css.map">
    </script>
    <script src="../../public/css/adminlte-colors.rtl.css">
    </script>
    <script src="../../public/css/adminlte-colors.rtl.css.map">
    </script>
    <script src="../../public/css/adminlte-colors.rtl.min.css">
    </script>
    <script src="../../public/css/adminlte-colors.rtl.min.css.map">
    </script>
    <script src="../../public/css/adminlte-docs.css">
    </script>
    <script src="../../public/css/adminlte-docs.css.map">
    </script>
    <script src="../../public/css/adminlte-docs.min.css">
    </script>
    <script src="../../public/css/adminlte-docs.min.css.map">
    </script>
    <script src="../../public/css/adminlte-docs.rtl.css">
    </script>
    <script src="../../public/css/adminlte-docs.rtl.css.map">
    </script>
    <script src="../../public/css/adminlte-docs.rtl.min.css">
    </script>
    <script src="../../public/css/adminlte-docs.rtl.min.css.map">
    </script>
    <script src="../../public/css/adminlte-select2.css">
    </script>
    <script src="../../public/css/adminlte-select2.css.map">
    </script>
    <script src="../../public/css/adminlte-select2.min.css">
    </script>
    <script src="../../public/css/adminlte-select2.min.css.map">
    </script>
    <script src="../../public/css/adminlte-select2.rtl.css">
    </script>
    <script src="../../public/css/adminlte-select2.rtl.css.map">
    </script>
    <script src="../../public/css/adminlte-select2.rtl.min.css">
    </script>
    <script src="../../public/css/adminlte-select2.rtl.min.css.map">
    </script>
    <script src="../../public/css/adminlte.css">
    </script>
    <script src="../../public/css/adminlte.css.map">
    </script>
    <script src="../../public/css/adminlte.min.css">
    </script>
    <script src="../../public/css/adminlte.min.css.map">
    </script>
    <script src="../../public/css/adminlte.rtl.css">
    </script>
    <script src="../../public/css/adminlte.rtl.css.map">
    </script>
    <script src="../../public/css/adminlte.rtl.min.css">
    </script>
    <script src="../../public/css/adminlte.rtl.min.css.map">
    </script>
    <!-- jsvectormap -->
    <script>
